...
class Block(nn.Module):
    ...
    def __init__(self, dim, drop_path=0., layer_scale_init_value=1e-6):
        ...
        self.dwconv = nn.Conv2d(dim, dim, kernel_size=(1, 9), padding=(0,4), groups=dim) # depthwise conv
...
class ConvNeXt(nn.Module):
    ...
    def __init__(self, stack_num=16, frame_skip=1,
        ...
        stem = nn.Sequential(
            nn.Conv2d(in_chans, dims[0], kernel_size=(1,3), stride= (1,3), padding = (0, 1)),
        ...
        for i in range(3):
            if i < 1 : #default 0
                downsample_layer = nn.Sequential(
                        ...
                        nn.Conv2d(dims[i], dims[i+1], kernel_size=(1, 1), stride=(1,1), padding = (0, 0)),
